...
export default function App() {
  ...
  const [loadingSubs, setLoadingSubs] = useState(false); // ✅ CHANGED
    ...
    <div className="dashboard-page">
      <div className="dashboard-card">
        ...
        <div className="tab-bar">
          <button className={view==="ALL"?"active-tab":""} onClick={()=>setView("ALL")}>
            All Stocks
          </button>
          <button className={view==="PORTFOLIO"?"active-tab":""} onClick={()=>setView("PORTFOLIO")}>
            Portfolio
          </button>
        </div>
          ...
          <>
            ...
            {STOCKS.map((stock) => (
              <div key={stock} className="stock-row">
                ...
                <button className="subscribe-btn" onClick={()=>setConfirmStock(stock)}>
                  Subscribe
                </button>
              </div>
            ))}
        ...
        {view==="PORTFOLIO" && (
          <>
            ...
            {subscribed.length === 0 && (
              <p className="no-stocks-message">No subscriptions yet.</p>
            )}
