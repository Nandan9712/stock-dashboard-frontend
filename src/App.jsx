...
export default function App() {
  ...
  const subscribeToStock = () => {
    ...
    if (!subscribed.includes(confirmStock)) setSubscribed((prev) => [...prev, confirmStock]);
    ...
    <div className="dashboard-page">
      <div className="dashboard-card">
        ...
        <div className="tab-bar">
          <button className={view==="ALL"?"active-tab":""} onClick={()=>setView("ALL")}>All Stocks</button>
          <button className={view==="PORTFOLIO"?"active-tab":""} onClick={()=>setView("PORTFOLIO")}>Portfolio</button>
        </div>
          ...
          <>
            ...
            {STOCKS.map((stock) => (
              <div key={stock} className="stock-row">
                ...
                <button className="subscribe-btn" onClick={()=>setConfirmStock(stock)}>Subscribe</button>
              </div>
            ))}
          </>
        )}
        ...
        {confirmStock && (
          <div className="popup">
            <div className="popup-box">
              ...
              <button className="cancel-btn" onClick={()=>setConfirmStock(null)}>No</button>
            </div>
          </div>
        )}
      </div>
